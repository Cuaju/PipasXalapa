...
public class Cita {
    ...
    public Cita(int idCita, String fecha, String hora, int idCliente, int idInmueble, String nombreCliente, String correoCliente, String nombreInmueble, String calleInmueble) {
        this.idCita = idCita;
        this.fecha = fecha;
        this.hora = hora;
