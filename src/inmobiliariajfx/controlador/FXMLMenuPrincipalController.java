...
public class FXMLMenuPrincipalController implements Initializable {
    ...
    private void btnClicAgendarCita(ActionEvent event) {
        try {
            ...
            FXMLAgendarCitasController controlador = loader.getController();
    ...
    private void imgCerrarSesion(MouseEvent event) {
        try{
            ...
            Parent root = FXMLLoader.load(inmobiliariajfx.Inmobiliariajfx.class.getResource("vista/FXMLIniciarSesion.fxml"));
